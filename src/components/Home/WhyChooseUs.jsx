  ...
  return (
    <section className="py-20 bg-white">
      <div className="text-center mb-16">
        <span className="text-purple-600 dark:text-purple-500 font-bold text-sm uppercase tracking-wider">Our Advantages</span>
        <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-gray-600 mb-4 mt-2">Why Choose HomeNest?</h2>
        <p className="text-gray-600 dark:text-gray-500 text-lg max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
        {features.map((feature, index) => (
          <div
            key={index}
            className="group p-8 rounded-2xl dark:bg-gray-200 bg-gray-50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 ">
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-20 mb-3 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
              {feature.title}
            </h3>
