  ...
  return (
    <section className="py-20 bg-white">
      <div className="text-center mb-16">
        <span className="text-purple-600 font-bold text-sm uppercase tracking-wider">Our Advantages</span>
        <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4 mt-2">Why Choose HomeNest?</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <div
            key={index}
            className="group p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-purple-50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100"
          >
